...
function HelperUtil_IsHarvestTime()
	return MathUtil_IndexOf( CityParams.HARVEST.HARVEST_TIME, g_calendar:GetMonth() ) and g_calendar:GetDay() <= 1
end

function HelperUtil_IsLevyTaxTime()
	return MathUtil_IndexOf( CityParams.LEVY_TAX.LEVY_TAX_TIME, g_calendar:GetMonth() ) and g_calendar:GetDay() <= 1
end

function HelperUtil_IsTurnOverTaxTime()
	return MathUtil_IndexOf( CityParams.TURN_OVER_TAX_TIME, g_calendar:GetMonth() ) and g_calendar:GetDay() <= 1
end
...
--]]
function HelperUtil_TrimString( str, finalLength, curLength )
	local ret
...
function HelperUtil_AbbreviateString( str, length )
	local ret = ""
